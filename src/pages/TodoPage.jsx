...
import { newTaskSchemas } from '../schemas/todoSchemas';
...
function TodoPage() {
  ...
  const hdlAddPostChange = async (e) => {
  ...
  const hdlAddPost = async (e) => {
    ...
    const validateResult = newTaskSchemas.safeParse(addPost);
    if (!validateResult.success) {
      const { content } = validateResult.error.flatten().fieldErrors;
      if (content) {
